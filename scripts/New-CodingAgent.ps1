...
foreach ($required in @('launcher\launch-coding-agent.ps1', 'launcher\launch-coding-agent.cmd', 'launcher\start-coding-agent.cmd')) {
...
try {
    ...
    Copy-Item -LiteralPath (Join-Path $source 'launcher\launch-coding-agent.ps1') -Destination (Join-Path $stageRoot 'launcher\launch-coding-agent.ps1') -Force
    Copy-Item -LiteralPath (Join-Path $source 'launcher\launch-coding-agent.cmd') -Destination (Join-Path $stageRoot 'launcher\launch-coding-agent.cmd') -Force
    Copy-Item -LiteralPath (Join-Path $source 'launcher\start-coding-agent.cmd') -Destination (Join-Path $stageRoot 'start-coding-agent.cmd') -Force
    ...
    $requiredStage = @(
        'launcher\launch-coding-agent.ps1', 'launcher\launch-coding-agent.cmd', ('apps\' + $AppName + '\manifest.json'),
