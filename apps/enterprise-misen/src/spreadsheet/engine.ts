...
// Pi capability aliases retain the thin Office Kit seam while keeping the
// public tool implementation compact and independently testable.
export const formula = writeFormula
export const put = writeRangeValues
