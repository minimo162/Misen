...
var server = import_node_http2.default.createServer(async (req, res) => {
  ...
  if (req.method === "GET" && url.pathname === "/api/info") {
    json(res, 200, { model: cfg.model || (cfg.provider ?? ""), provider: cfg.provider ?? "openai", workspace, project: import_node_path4.default.basename(workspace), version: "0.10.6", distribution: readDistributionState() });
    return;
  }
